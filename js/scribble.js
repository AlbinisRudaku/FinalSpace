...
var characterList = ['Gary', 'Mooncake', 'Quinn', 'Little Cato', 'Avocato', 'KVN', 'Ash', 'Fox', 'H.U.E', 'Tribore', 'Clarence', 'Biskit', 'Commander', 'Bolo', 'Invictus', 'Nightfall', 'A.V.A'];

//stocks possible character attributes
var layers = {
    n: 4, //number of layers
    letters: [70, 30, 20, 15], //letters per layer (starting from the deepest layer)
    coef: [0.1, 0.2, 0.4, 0.6, 0.8], //how much the letters move from the mouse (starting from the deepest layer)
    size: [8, 16, 24, 32, 40], //font size of the letters (starting from the deepest layer)
    color: ['#aaa', '#aaa', '#aaa', '#aaa', '#999'], //color of the letters (starting from the deepest layer)
    font: 'Rubik' //font family (of every layer)
};
